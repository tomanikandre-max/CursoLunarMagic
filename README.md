...
Não incentivamos, apoiamos ou promovemos a distribuição ilegal de jogos ou a pirataria. Os links para materiais de terceiros e ferramentas externas servem exclusivamente como referências técnicas para fins de preservação e estudo de software.

## Créditos e Propriedade Intelectual

**Super Mario World** e todos os personagens, recursos visuais, trilhas sonoras e marcas registradas associadas são de propriedade intelectual exclusiva da **Nintendo Co., Ltd.** Este é um projeto sem fins lucrativos, feito de fã para fã, com o único intuito de estudar e celebrar a engenharia de software de um dos maiores clássicos da história dos videogames.
